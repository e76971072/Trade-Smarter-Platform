  ...
  (l.widgetId.get = function () {
    ...
    (c.prototype._getScriptsInfo = function () {
      ...
      var l,
        h =
          ...
          l.match(/^[a-z]{2}\.tradingview\.com/) ||
          l.match(/prod-[^.]+.tradingview.com/)
            ? "battle"
            : -1 !== l.indexOf("tradingview.com")
            ? "staging"
            : l.match(/webcharts/)
            ? "staging_local"
            : (l.match(/^localhost(:\d+)?$/), "local"));
    ...
    (c.prototype._replaceScript = function (t) {
      ...
      var s = this._scriptContentToJSON(),
        ...
        l = !!this.script.parentNode.querySelector(
          ".tradingview-widget-copyright"
        );
      (this.hasCopyright = c || l),
      ...
      return (
        ...
        (i.propertiesToWorkWith.get = function () {
          return [
            ...
            "showSymbolLogo",
            "symbolActiveColor",
            "symbolDescriptionColor",
            "symbolSeparatorColor",
            "symbolShortNameColor",
            "tickerColorFalling",
            "tickerColorGrowing",
            "whitelabel",
            "width",
