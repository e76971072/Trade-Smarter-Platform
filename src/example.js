! function () {
	...
	l.widgetId.get = function () {
		...
		this.settings.utm_source = location.hostname, this.settings.utm_medium = l ? "widget_new" : "widget", this.settings.utm_campaign = this.widgetUtmName, this.iframe = this._createIframe(m, p, n, r, a.id);
		...
		return i.widgetId.get = function () {
			...
			return ["belowLineFillColorFalling", "belowLineFillColorGrowing", "colorTheme", "customer", "exchange", "gridLineColor", "height", "dateRange", "isTransparent", "largeChartUrl", "locale", "plotLineColorFalling", "plotLineColorGrowing", "scaleFontColor", "showChart", "showSymbolLogo", "symbolActiveColor", "symbolDescriptionColor", "symbolSeparatorColor", "symbolShortNameColor", "tickerColorFalling", "tickerColorGrowing", "whitelabel", "width"]
